...
## Overview
Magic MIDI is an intelligent music editor that allows users to compose MIDI tracks in the browser. Unlike standard editors, this tool features a **"Ghost Writer"**—an AI agent that listens to your current track, analyzes the harmony and rhythm of the other instruments (drums, bass, keys), and **instantly generates a continuation** of your melody.

It doesn't just generate random notes; it acts as a **Music Theory Teacher**, explaining *why* it chose those notes (e.g., "I landed on the root note to resolve the tension").
